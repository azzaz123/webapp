...
export const MOCK_KYC_DOCUMENT_IMAGE_SIZE_EXCEEDED_RESPONSE: KYCErrorResponseApi<KYC_ERROR_CODES> = {
  ...MOCK_KYC_BASE_ERROR_RESPONSE,
  error: [MOCK_KYC_DOCUMENT_IMAGE_SIZE_EXCEEDED],
};

export const MOCK_KYC_DOCUMENT_IMAGE_INVALID_INPUT_FILE_RESPONSE: KYCErrorResponseApi<KYC_ERROR_CODES> = {
  ...MOCK_KYC_BASE_ERROR_RESPONSE,
  error: [MOCK_KYC_DOCUMENT_IMAGE_INVALID_INPUT_FILE],
};

export const MOCK_KYC_DOCUMENT_IMAGE_INVALID_RESPONSE: KYCErrorResponseApi<KYC_ERROR_CODES> = {
  ...MOCK_KYC_BASE_ERROR_RESPONSE,
