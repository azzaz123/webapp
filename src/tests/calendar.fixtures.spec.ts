...
export const MOCK_SELECTED_DATES: CalendarDates = new CalendarDates(MOCK_DATE, MOCK_DATE2);

export const MOCK_SELECTED_DATES_TIMEZONE: CalendarDates = new CalendarDates(MOCK_DATE4, MOCK_DATE5);
