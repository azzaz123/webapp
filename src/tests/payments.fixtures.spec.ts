...
export function createPacksFixture(): Packs {
  ...
  const packCityBump = new Pack('1', 1, 5.99, 'EUR', 'cityBump');
  packCityBump.calculateDiscount('5.99', 1, 5.99);
  const packCityBumpSecond = new Pack('2', 5, 15.99, 'EUR', 'cityBump');
  packCityBumpSecond.calculateDiscount('15.99', 5, 5.99);
  const packCityBumpThird = new Pack('3', 15, 25.99, 'EUR', 'cityBump');
  ...
  const packNationalBump = new Pack('4', 1, 8.99, 'EUR', 'countryBump');
  packNationalBump.calculateDiscount('8.99', 1, 8.99);
  const packNationalBumpSecond = new Pack('5', 5, 18.99, 'EUR', 'countryBump');
  packNationalBumpSecond.calculateDiscount('18.99', 5, 8.99);
  const packNationalBumpThird = new Pack('6', 15, 28.99, 'EUR', 'countryBump');
...
export const WALLACOINS_PACKS_RESPONSE: PackResponse[] = [
  ...
  },
  {
    ...
    benefits: { [COINS_PACK_ID]: 29000.0 },
    price: '250.00',
  ...
  },
  {
    ...
    benefits: { [COINS_PACK_ID]: 125000.0 },
    price: '1000.00',
  ...
  },
  {
    ...
    benefits: { [COINS_PACK_ID]: 11500.0 },
    price: '100.00',
  ...
  },
  {
    ...
    benefits: { [COINS_PACK_ID]: 60000.0 },
    price: '500.00',
...
export const WALLACREDITS_PACKS_RESPONSE: PackResponse[] = [
  {
    id: '05265bfc-423d-4e38-989b-7079c83ca4d7',
    benefits: { [CREDITS_PACK_ID]: 5500.0 },
    price: '50.00',
    original_price: '55.00',
    currency: 'EUR',
  },
  {
    id: '2756ccaf-d59b-4fab-9758-163cc52f5246',
    benefits: { [CREDITS_PACK_ID]: 29000.0 },
    price: '250.00',
    original_price: '290.00',
    currency: 'EUR',
  },
  {
    id: '8913678e-b1a2-47c4-a954-5257dfc1df85',
    benefits: { [CREDITS_PACK_ID]: 125000.0 },
    price: '1000.00',
    original_price: '1250.00',
    currency: 'EUR',
  },
  {
    id: '994a1c68-c3dd-4e85-824e-8d1ae9d1a95a',
    benefits: { [CREDITS_PACK_ID]: 11500.0 },
    price: '100.00',
    original_price: '115.00',
    currency: 'EUR',
  },
  {
    id: 'e631c995-a9cb-4db3-a746-435b63dddc02',
    benefits: { [CREDITS_PACK_ID]: 3000.0 },
    price: '30.00',
    original_price: '30.00',
    currency: 'EUR',
  },
  {
    id: 'eaa7e591-6d86-4b62-94de-7ab8013a280b',
    benefits: { [CREDITS_PACK_ID]: 60000.0 },
    price: '500.00',
    original_price: '600.00',
    currency: 'EUR',
  },
