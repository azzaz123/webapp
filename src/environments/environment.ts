...
export const environment: any = {
  ...
  profeatures: true,
  name: 'local',
  baseUrl: 'https://apigw.dock137.wallapop.com/',
  xmppDomain: 'dock137.wallapop.com',
  wsUrl: 'wss://dock137.wallapop.com:5282/ws-xmpp',
  siteUrl: 'https://es.dock137.wallapop.com/',
