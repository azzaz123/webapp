...
export const environment: any = {
  ...
  profeatures: true,
  name: 'local',
  baseUrl: 'https://apigw.dock146.wallapop.com/',
  xmppDomain: 'dock146.wallapop.com',
  wsUrl: 'wss://dock146.wallapop.com:5282/ws-xmpp',
  siteUrl: 'https://es.dock146.wallapop.com/',
