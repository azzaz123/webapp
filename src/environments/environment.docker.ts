...
export const environment: Environment = {
  production: false,
  name: 'docker',
  appDomain: `.${docknum}.pub.dockx.wallapop.com/`,
  protocol: 'https://',
  baseUrl: `https://apigw.${docknum}.pub.dockx.wallapop.com/`,
  xmppDomain: `${docknum}.pub.dockx.wallapop.com`,
  wsUrl: `wss://${docknum}.pub.dockx.wallapop.com:5282/ws-xmpp`,
