import {
  ...
  Input,
  ChangeDetectorRef,
  SimpleChanges, AfterViewInit, OnDestroy, OnChanges
} from '@angular/core';
...
export class StripeCardElementComponent implements ControlValueAccessor, AfterViewInit, OnDestroy, OnChanges {
