...
describe('MultiSelectFormV2Component', () => {
  let component: MultiSelectFormV2Component;
  let debugElement: DebugElement;
  let fixture: ComponentFixture<MultiSelectFormV2Component>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MultiSelectFormV2Component);
