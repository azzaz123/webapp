...
@Component({
  selector: 'tsl-multi-select-form-v2',
  templateUrl: './multi-select-form-v2.component.html',
  styleUrls: ['./multi-select-form-v2.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => MultiSelectFormV2Component),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MultiSelectFormV2Component extends AbstractFormComponent<MultiSelectValue> {
