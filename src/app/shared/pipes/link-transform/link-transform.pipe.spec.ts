...
describe('LinkTransformPipe', () => {
  ...
  it('should transform message with double link to message with clickable link', () => {
    ...
    expect(pipe.transform('First link https://es.wallapop.com second link https://www.google.pl')).toEqual(
  ...
  it('should transform message with double repetitive link to message with clickable link', () => {
    ...
    expect(pipe.transform('First link https://es.wallapop.com second link https://es.wallapop.com')).toEqual(
  ...
  it('should transform message without protocol to clickable link', () => {
    ...
    expect(pipe.transform('Link: www.wallapop.com')).toEqual('Link: <a href="//www.wallapop.com" target="_blank">www.wallapop.com</a>');
    expect(pipe.transform('Link: wallapop.com')).toEqual('Link: <a href="//wallapop.com" target="_blank">wallapop.com</a>');
  });
  ...
  it('should return true if is in wallapop domain', () => {
    ...
    expect('https://www.wallapop.com'.match(LinkTransformPipe.WALLAPOP_REG_EXP)).toBeTruthy();
    expect('https://www.wallapop.com?key=value'.match(LinkTransformPipe.WALLAPOP_REG_EXP)).toBeTruthy();
