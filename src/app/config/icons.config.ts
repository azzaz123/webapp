...
export function configIcons(matIconRegistry: MatIconRegistry, sanitizer: DomSanitizer) {
  ...
  matIconRegistry.addSvgIcon('category_Cars-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/cars.svg'));
  matIconRegistry.addSvgIcon('category_MotorAccessories-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/motoraccesories.svg'));
  matIconRegistry.addSvgIcon('category_TVAudioCameras-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/tv.svg'));
  matIconRegistry.addSvgIcon('category_ComputersElectronic-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/computing.svg'));
  matIconRegistry.addSvgIcon('category_CellPhonesAccessories-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/electronics.svg'));
  matIconRegistry.addSvgIcon('category_SportsLeisure-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/sports.svg'));
  matIconRegistry.addSvgIcon('category_Bikes-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/bikes.svg'));
  matIconRegistry.addSvgIcon('category_GamesConsoles-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/gaming.svg'));
  matIconRegistry.addSvgIcon('category_HomeGarden-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/home.svg'));
  matIconRegistry.addSvgIcon('category_FashionAccessories-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/fashion.svg'));
  matIconRegistry.addSvgIcon('category_Appliances-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/electrodomestics.svg'));
  matIconRegistry.addSvgIcon('category_GamesBooks-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/movies.svg'));
  matIconRegistry.addSvgIcon('category_BabiesChild-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/babys.svg'));
  matIconRegistry.addSvgIcon('category_CollectiblesArt-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/collecting.svg'));
  matIconRegistry.addSvgIcon('category_Construction-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/construction.svg'));
  matIconRegistry.addSvgIcon('category_AgricultureIndustrial-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/agriculture.svg'));
  ...
  matIconRegistry.addSvgIcon('category_RealEstate-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/realstate.svg'));
  matIconRegistry.addSvgIcon('category_Services-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/services.svg'));
  matIconRegistry.addSvgIcon('category_Others-disabled', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/categories/disabled/others.svg'));
