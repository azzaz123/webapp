...
export function configIcons(mdIconRegistry: MdIconRegistry, sanitizer: DomSanitizer) {
  ...
  mdIconRegistry.addSvgIcon('category-appliances', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_Appliances.svg'));
  mdIconRegistry.addSvgIcon('category-babies', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_Babies.svg'));
  mdIconRegistry.addSvgIcon('category-cars', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_Cars.svg'));
  mdIconRegistry.addSvgIcon('category-electronics', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_Electronics.svg'));
  mdIconRegistry.addSvgIcon('category-games-books', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_GamesBooks.svg'));
  mdIconRegistry.addSvgIcon('category-god', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_God.svg'));
  mdIconRegistry.addSvgIcon('category-home-garden', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_HomeGarden.svg'));
  mdIconRegistry.addSvgIcon('category-housing', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_Housing.svg'));
  mdIconRegistry.addSvgIcon('category-moda', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_Moda.svg'));
  mdIconRegistry.addSvgIcon('category-motor', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_Motor.svg'));
  mdIconRegistry.addSvgIcon('category-other', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_Others.svg'));
  mdIconRegistry.addSvgIcon('category-services', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_Services.svg'));
  mdIconRegistry.addSvgIcon('category-sports', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_Sports.svg'));
  mdIconRegistry.addSvgIcon('category-videogames', sanitizer.bypassSecurityTrustResourceUrl('/assets/icons/category_Videogames.svg'));
}
