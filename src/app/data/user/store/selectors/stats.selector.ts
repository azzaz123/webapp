...
const selectUserStatsState = createSelector(
  selectUserFeature,
  (userState: UserState) => userState.stats
);

export const selectUserStats = createSelector(
  selectUserStatsState,
  (userStatsState: UserStatsState) => userStatsState.stats
);
...
export const selectUserStatsLoading = createSelector(
  selectUserStatsState,
  (userStatsState: UserStatsState) => userStatsState.loading
);
