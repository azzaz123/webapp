...
const selectUserProfileState = createSelector(selectUserFeature, (userState: UserState) => userState.profile);
...
export const selectUserProfileDetailId = createSelector(selectUserProfileDetail, (profile: Profile) => profile?.id);
