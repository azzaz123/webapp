...
export const DEFAULT_FILTER_CONFIGURATION: BubbleDrawerConfiguration = {
  bubble: [DEFAULT_FILTER_ID.CATEGORIES, DEFAULT_FILTER_ID.PRICE, DEFAULT_FILTER_ID.CONDITION, DEFAULT_FILTER_ID.LOCATION],
  drawer: [
    DEFAULT_FILTER_ID.CATEGORIES,
    DEFAULT_FILTER_ID.PRICE,
    DEFAULT_FILTER_ID.CONDITION,
    DEFAULT_FILTER_ID.LOCATION,
    DEFAULT_FILTER_ID.POSTED_AGO,
  ],
};
