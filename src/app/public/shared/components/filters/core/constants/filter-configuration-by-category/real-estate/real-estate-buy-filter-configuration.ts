...
export const REAL_ESTATE_BUY_DEFAULT_FILTER_CONFIGURATION: FilterIdConfiguration = {
  bubble: [REAL_ESTATE_BUY_DEFAULT_FILTER_ID.PRICE],
  drawer: [REAL_ESTATE_BUY_DEFAULT_FILTER_ID.PRICE],
};

export const REAL_ESTATE_BUY_HOUSE_FILTER_CONFIGURATION: FilterIdConfiguration = {
...
export const REAL_ESTATE_BUY_FLAT_FILTER_CONFIGURATION: FilterIdConfiguration = {
...
export const REAL_ESTATE_BUY_OFFICE_FILTER_CONFIGURATION: FilterIdConfiguration = {
...
export const REAL_ESTATE_BUY_GARAGE_FILTER_CONFIGURATION: FilterIdConfiguration = {
  bubble: [REAL_ESTATE_BUY_GARAGE_FILTER_ID.PRICE],
  drawer: [REAL_ESTATE_BUY_GARAGE_FILTER_ID.PRICE],
};

export const REAL_ESTATE_BUY_LAND_FILTER_CONFIGURATION: FilterIdConfiguration = {
...
export const REAL_ESTATE_BUY_BOX_ROOM_FILTER_CONFIGURATION: FilterIdConfiguration = {
