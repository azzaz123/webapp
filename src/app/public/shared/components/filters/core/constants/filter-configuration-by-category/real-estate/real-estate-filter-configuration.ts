import {
  ...
  REAL_ESTATE_APARTMENT_FILTER_ID,
...
export const REAL_ESTATE_APARTMENT_FILTER_CONFIGURATION: BubbleDrawerConfiguration = {
  bubble: [
    REAL_ESTATE_APARTMENT_FILTER_ID.CATEGORIES,
    REAL_ESTATE_APARTMENT_FILTER_ID.OPERATION,
    REAL_ESTATE_APARTMENT_FILTER_ID.TYPE,
    REAL_ESTATE_APARTMENT_FILTER_ID.PRICE,
    REAL_ESTATE_APARTMENT_FILTER_ID.SURFACE,
  ],
  drawer: [
    REAL_ESTATE_APARTMENT_FILTER_ID.CATEGORIES,
    REAL_ESTATE_APARTMENT_FILTER_ID.OPERATION,
    ...
    REAL_ESTATE_APARTMENT_FILTER_ID.PRICE,
    REAL_ESTATE_APARTMENT_FILTER_ID.SURFACE,
    REAL_ESTATE_APARTMENT_FILTER_ID.ROOMS,
    REAL_ESTATE_APARTMENT_FILTER_ID.BATHROOMS,
    REAL_ESTATE_APARTMENT_FILTER_ID.CONDITION,
    REAL_ESTATE_APARTMENT_FILTER_ID.POSTED_AGO,
  ],
};
