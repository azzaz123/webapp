...
export const MOCK_CELLPHONE_EXTRA_INFO = [ITEM_CELLPHONES_EXTRA_INFO.brand, ITEM_CELLPHONES_EXTRA_INFO.model].map((string) =>
  capitalizeString(string)
);

export const MOCK_FASHION_EXTRA_INFO = [
...
export const MOCK_CAR_EXTRA_INFO = [MOCK_CAR.version, MOCK_CAR.year.toString(), `${MOCK_CAR.km}Km`].map((string) =>
  capitalizeString(string)
);
