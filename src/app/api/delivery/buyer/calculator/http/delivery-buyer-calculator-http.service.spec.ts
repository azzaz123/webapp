  ...
  describe('WHEN asking to get the buyer calculator costs', () => {
    describe('AND WHEN there is no promotion', () => {
      it('should ask server for getting this information', () => {
        ...
        const expectedUrl: string = `${DELIVERY_BUYER_CALCULATOR_COSTS_ENDPOINT}?product_price_amount=${money.amount.total}&product_price_currency=${money.currency.code}&item_id=${itemId}&promocode=null&carrier_delivery_mode=${DELIVERY_MODE[deliveryMode]}`;
    ...
    describe('AND WHEN there is a promotion code', () => {
      it('should ask server for getting this information', () => {
        ...
        const expectedUrl: string = `${DELIVERY_BUYER_CALCULATOR_COSTS_ENDPOINT}?product_price_amount=${money.amount.total}&product_price_currency=${money.currency.code}&item_id=${itemId}&promocode=${promocode}&carrier_delivery_mode=${DELIVERY_MODE[deliveryMode]}`;
