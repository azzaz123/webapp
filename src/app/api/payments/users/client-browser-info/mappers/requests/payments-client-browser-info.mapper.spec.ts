import { MOCK_PAYMENT_CLIENT_BROWSER_INFO } from '@api/fixtures/core/model/payments/payment-client-browser-info.fixtures.spec';
...
describe('mapPaymentsClientBrowserInfoToDto', () => {
  describe('when transforming payments client browser info to server context', () => {
    it('should transform the data', () => {
      const result = mapPaymentsClientBrowserInfoToDto(MOCK_PAYMENT_CLIENT_BROWSER_INFO);
