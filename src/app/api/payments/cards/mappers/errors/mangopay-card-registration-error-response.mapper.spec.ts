import { MOCK_INVALID_CARD_NUMBER_CARD_REGISTRATION_ERROR_RESPONSE } from '@api/fixtures/payments/cards/mangopay-card-registration-errors.fixtures.spec';
...
describe('mapMangopayCardRegistrationErrorResponse', () => {
  describe('when mapping Mangopay card registration invalid response', () => {
    it('should map to network error', () => {
      const mappedError = mapMangopayCardRegistrationErrorResponse(MOCK_INVALID_CARD_NUMBER_CARD_REGISTRATION_ERROR_RESPONSE);
