...
export class MeHttpService {
  ...
  public getMyNotificationsSettings(): Observable<NotificationsSettingsDto> {
    return this.httpClient.get<NotificationsSettingsDto>(NOTIFICATIONS_API_URL_ENDPOINT);
  }
}
