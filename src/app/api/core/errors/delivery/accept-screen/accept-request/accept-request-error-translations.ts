export const AcceptRequestErrorTranslations = {
  ...
  SELLER_ADDRESS_NOT_FOUND: $localize`:@@accept_view_seller_all_all_snackbar_pending_sender_details_error:Please enter the sender address.`,
  ...
  SELLER_BLOCKED_BY_BUYER: $localize`:@@accept_view_seller_all_all_snackbar_seller_banner_by_buyer_error:Sorry, you can't accept the offer as the buyer has blocked you.`,
  ...
  POSTAL_CODE_NOT_FOUND: $localize`:@@accept_view_seller_all_all_snackbar_seller_post_code_not_allowed_error:Shipments can't be made from this address. We're very sorry!`,
