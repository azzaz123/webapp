...
const deliveryPendingTransactionBuyerTranslationsRelation: Record<DELIVERY_ONGOING_STATUS, string> = {
  ...
  [DELIVERY_ONGOING_STATUS.TRANSACTION_ERROR]: $localize`:@@web_purchases_view_buyer_all_all_shipping_failed_ongoing_tab_shipping_status_label:Shipment not completed`,
...
const deliveryPendingTransactionSellerTranslationsRelation: Record<DELIVERY_ONGOING_STATUS, string> = {
  ...
  [DELIVERY_ONGOING_STATUS.TRANSACTION_ERROR]: $localize`:@@web_sales_view_seller_all_all_shipping_failed_ongoing_tab_shipping_status_label:Shipment not completed`,
