...
export const MOCK_CARRIER_DROP_OFF_MODE_DTO: CarrierDropOffModeRequestDto = {
  drop_off_modes: [
    {
      drop_off_mode: 'POST_OFFICE',
      icon: 'http://prod-delivery-resources.wallapop.com/Correos.png',
      post_office_details: { carrier: 'correos', last_address_used: null, selection_required: false },
