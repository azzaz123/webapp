...
export const MOCK_PAYMENTS_CLIENT_BROWSER_INFO: PaymentsClientBrowserInfo = {
  ...
  timeZoneOffset: '+60',
  userAgent:
    'Mozilla/5.0 (Linux; Android 10; ONEPLUS A5010 Build/QKQ1.191014.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/99.0.4844.58 Mobile Safari/537.36',
};
