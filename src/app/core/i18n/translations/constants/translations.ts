...
export const translations: Translations = {
  ...
  [TRANSLATION_KEY.DELIVERY_ADDRESS_POSTAL_CODE_NOT_ALLOWED_ERROR]: $localize`:@@address_view_all_users_form_textfield_postalcode_not_allowed_before_save_inline_error:This ZIP code doesn't allow to proceed with the shipment`,
