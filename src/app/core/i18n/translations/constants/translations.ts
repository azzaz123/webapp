...
export const translations: Translations = {
  ...
  [TRANSLATION_KEY.DELIVERY_BANK_ACCOUNT_POPUP_TITLE_DELETE]: $localize`:@@delivery_delete_bank_account_confirmation_popup_title:Delete account`,
  [TRANSLATION_KEY.DELIVERY_BANK_ACCOUNT_POPUP_DESCRIPTION_DELETE]: $localize`:@@delivery_delete_bank_account_confirmation_popup_message:This action can’t be undone. Are you sure you want to delete the bank account?`,
  [TRANSLATION_KEY.DELIVERY_BANK_ACCOUNT_POPUP_ACCEPT_BUTTON_DELETE]: $localize`:@@delivery_delete_bank_account_confirmation_popup_accept:Delete`,
  [TRANSLATION_KEY.DELIVERY_BANK_ACCOUNT_POPUP_CANCEL_BUTTON_DELETE]: $localize`:@@delivery_delete_bank_account_confirmation_popup_cancel:Cancel`,
