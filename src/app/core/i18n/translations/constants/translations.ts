...
export const translations: Translations = {
  ...
  [TRANSLATION_KEY.DELIVERY_ADDRESS_DELETE_SUCCESS]: $localize`:@@address_view_all_users_snackbar_remove_success:Address deleted successfully`,
  ...
  [TRANSLATION_KEY.DELIVERY_ADDRESS_DELETE_REQUEST_TITLE]: $localize`:@@pre_address_view_all_users_address_added_remove_confirmation_modal_title:¿Confirmas que quieres eliminar la dirección?`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_DELETE_REQUEST_DESCRIPTION]: $localize`:@@pre_address_view_all_users_address_added_remove_confirmation_modal_body:You cannot undo this action. Are you sure you want to delete your address?`,
  ...
  [TRANSLATION_KEY.DELIVERY_ADDRESS_DELETE_CANCEL]: $localize`:@@pre_address_view_all_users_address_added_remove_confirmation_modal_back_button:Cancel`,
};
