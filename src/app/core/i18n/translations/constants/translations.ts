...
export const translations: Translations = {
  ...
  [TRANSLATION_KEY.DELIVERY_ADDRESS_SAVE_SUCCESS]: $localize`:@@delivery_address_save_success:Address edited successfully!`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_SAVE_ERROR]: $localize`:@@delivery_address_save_error:Sorry, something went wrong. Try again.`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_SAVE_MISSING_INFO_ERROR]: $localize`:@@address_view_all_users_snackbar_missing_info_error:The missing data is necessary to save`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_SAVE_INVALID_POSTAL_CODE_ERROR]: $localize`:@@delivery_address_save_invalid_postal_code_error:We couldn't save postal code because it isn't valid`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_SAVE_POSTAL_CODE_NOT_ALLOWED_ERROR]: $localize`:@@delivery_address_save_invalid_postal_code_not_allowed_error:We couldn't save postal code because it isn't allowed`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_POSTAL_CODE_NOT_EXISTS_ERROR]: $localize`:@@delivery_address_postal_code_not_exist_error:Postal code doesn't exist`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_SAVE_INVALID_PHONE_NUMBER_ERROR]: $localize`:@@delivery_address_save_invalid_phone_number_error:Error saving. This phone number is invalid.`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_SAVE_FLATANDFLOOR_TOO_LONG_ERROR]: $localize`:@@delivery_flat_and_floor_too_long_hint_error:That's is too long! Please write it shorter.`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_SAVE_TOO_LONG_ERROR]: $localize`:@@delivery_address_too_long_hint_error:That's is too long! Please write it shorter.`,
