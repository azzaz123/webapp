...
export const translations: Translations = {
  ...
  [TRANSLATION_KEY.DELIVERY_ADDRESS_DELETE_SUCCESS]: $localize`:@@delivery_delete_address_succeed:Address deleted successfully`,
  ...
  [TRANSLATION_KEY.DELIVERY_ADDRESS_PHONE_NUMBER_INVALID_ERROR]: $localize`:@@delivery_address_invalid_phone_number_error:This phone number is invalid`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_TOO_LONG_HINT_ERROR]: $localize`:@@delivery_address_too_long_hint_error:That's is too long! Please write it shorter.`,
  ...
  [TRANSLATION_KEY.DELIVERY_ADDRESS_DELETE_REQUEST]: $localize`:@@delivery_delete_address_confirmation_popup_message:You cannot undo this action. Are you sure you want to delete your address?`,
  [TRANSLATION_KEY.CANCEL]: $localize`:@@cancel:Cancel`,
  [TRANSLATION_KEY.DELETE]: $localize`:@@delete:Delete`,
