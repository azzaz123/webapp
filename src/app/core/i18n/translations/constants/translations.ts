...
export const translations: Translations = {
  ...
  [TRANSLATION_KEY.DELIVERY_ADDRESS_POSTAL_CODE_NOT_EXISTS_ERROR]: $localize`:@@web_delivery_address_postal_code_not_exist_error:Postal code doesn't exist`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_PHONE_NUMBER_INVALID_ERROR]: $localize`:@@web_delivery_address_invalid_phone_number_error:This phone number is invalid`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_TOO_LONG_HINT_ERROR]: $localize`:@@web_delivery_address_too_long_hint_error:That's is too long! Please write it shorter.`,
