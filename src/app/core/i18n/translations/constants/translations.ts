...
export const translations: Translations = {
  ...
  [TRANSLATION_KEY.SUBSCRIPTION_CARD_NOT_SET_ERROR]: `:@@web_subscription_card_not_set_error:Your card could not be saved`,
  [TRANSLATION_KEY.STRIPE_CARDS_RETRIEVAL_ERROR]: `:@@web_stripe_cards_retrieval_error:Your cards could not be retrieved`,
