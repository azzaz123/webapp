...
export const translations: Translations = {
  ...
  [TRANSLATION_KEY.DELIVERY_ADDRESS_CREATE_SUCCESS]: $localize`:@@address_view_all_users_snackbar_save_success:The address has been saved successfully. Ready to rumble!`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_EDIT_SUCCESS]: $localize`:@@address_view_all_users_snackbar_edit_success:The address has been edited successfully. Perfect!`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_DELETE_SUCCESS]: $localize`:@@address_view_all_users_snackbar_remove_success:The address has been removed successfully.`,
  ...
  [TRANSLATION_KEY.DELIVERY_ADDRESS_DELETE_REQUEST_TITLE]: $localize`:@@pre_address_view_all_users_address_added_remove_confirmation_modal_title:Want to remove the address?`,
  [TRANSLATION_KEY.DELIVERY_ADDRESS_DELETE_REQUEST_DESCRIPTION]: $localize`:@@pre_address_view_all_users_address_added_remove_confirmation_modal_body:You are going to remove the address. The action can't be undone.`,
  ...
  [TRANSLATION_KEY.BANK_ACCOUNT_ADD_SUCCESS]: $localize`:@@bank_account_form_snackbar_info_added_success_message:Bank account added successfully!`,
  [TRANSLATION_KEY.BANK_ACCOUNT_EDIT_SUCCESS]: $localize`:@@bank_account_form_snackbar_info_edit_success_message:Bank account edited successfully!`,
  ...
  [TRANSLATION_KEY.BANK_ACCOUNT_SAVE_GENERIC_ERROR]: $localize`:@@bank_account_form_snackbar_generic_error:Sorry, something went wrong`,
  [TRANSLATION_KEY.BANK_ACCOUNT_MISSING_INFO_ERROR]: $localize`:@@bank_account_form_snackbar_data_required_error:The missing data is necessary to save.`,
  ...
  [TRANSLATION_KEY.BANK_DETAILS_POPUP_REMOVE_BANK_ACCOUNT_TITLE]: $localize`:@@bank_list_view_pop_up_remove_bank_account_title:Delete account`,
  [TRANSLATION_KEY.BANK_DETAILS_POPUP_REMOVE_BANK_ACCOUNT_DESCRIPTION]: $localize`:@@bank_list_view_pop_up_remove_bank_account_description:This action can't be undone. Are you sure you want to delete the bank account?`,
  [TRANSLATION_KEY.BANK_DETAILS_POPUP_REMOVE_BANK_ACCOUNT_CONFIRM]: $localize`:@@bank_list_view_pop_up_remove_bank_account_confirm_button:Delete`,
  [TRANSLATION_KEY.BANK_DETAILS_POPUP_REMOVE_BANK_ACCOUNT_CANCEL]: $localize`:@@bank_list_view_pop_up_remove_bank_account_cancel_button:Cancel`,
  [TRANSLATION_KEY.BANK_DETAILS_POPUP_REMOVE_CREDIT_CARD_TITLE]: $localize`:@@bank_list_view_pop_up_remove_credit_card_title:Confirm card deletion`,
  [TRANSLATION_KEY.BANK_DETAILS_POPUP_REMOVE_CREDIT_CARD_DESCRIPTION]: $localize`:@@bank_list_view_pop_up_remove_credit_card_description:This action can't be undone. Are you sure you want to delete the bank card?`,
  [TRANSLATION_KEY.BANK_DETAILS_POPUP_REMOVE_CREDIT_CARD_CONFIRM]: $localize`:@@bank_list_view_pop_up_remove_credit_card_confirm_button:Delete`,
  [TRANSLATION_KEY.BANK_DETAILS_POPUP_REMOVE_CREDIT_CARD_CANCEL]: $localize`:@@bank_list_view_pop_up_remove_credit_card_cancel_button:Cancel`,
  [TRANSLATION_KEY.BANK_DETAILS_DELETE_BANK_ACCOUNT_SUCCESS]: $localize`:@@bank_list_view_snackbar_bank_account_removed_success_message:The bank account has been removed successfully.`,
  [TRANSLATION_KEY.BANK_DETAILS_DELETE_BANK_ACCOUNT_ERROR]: $localize`:@@bank_list_view_snackbar_bank_account_generic_error_message:Sorry, something went wrong. Try again.`,
  [TRANSLATION_KEY.BANK_DETAILS_DELETE_CREDIT_CARD_SUCCESS]: $localize`:@@bank_list_view_snackbar_credit_card_removed_success_message:The credit card has been removed successfully.`,
  [TRANSLATION_KEY.BANK_DETAILS_DELETE_CREDIT_CARD_ERROR]: $localize`:@@bank_list_view_snackbar_credit_card_generic_error_message:Sorry, something went wrong. Try again.`,
