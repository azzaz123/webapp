export enum TRANSLATION_KEY {
  ...
  DELIVERY_BANK_ACCOUNT_POPUP_TITLE_DELETE,
  DELIVERY_BANK_ACCOUNT_POPUP_DESCRIPTION_DELETE,
  DELIVERY_BANK_ACCOUNT_POPUP_ACCEPT_BUTTON_DELETE,
  DELIVERY_BANK_ACCOUNT_POPUP_CANCEL_BUTTON_DELETE,
  DELIVERY_CREDIT_CARD_POPUP_TITLE_DELETE,
  DELIVERY_CREDIT_CARD_POPUP_DESCRIPTION_DELETE,
  DELIVERY_CREDIT_CARD_POPUP_ACCEPT_BUTTON_DELETE,
  DELIVERY_CREDIT_CARD_POPUP_CANCEL_BUTTON_DELETE,
  DELIVERY_BANK_ACCOUNT_DELETE_SUCCESS,
  DELIVERY_BANK_ACCOUNT_DELETE_ERROR,
  ...
  ZENDESK_CONSUMER_GOODS_LIMIT_URL,
