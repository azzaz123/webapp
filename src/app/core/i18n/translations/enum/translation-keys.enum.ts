export enum TRANSLATION_KEY {
  ...
  DELIVERY_ADDRESS_SAVE_MISSING_INFO_ERROR,
  DELIVERY_ADDRESS_SAVE_INVALID_POSTAL_CODE_ERROR,
  DELIVERY_ADDRESS_SAVE_POSTAL_CODE_NOT_ALLOWED_ERROR,
  DELIVERY_ADDRESS_SAVE_INVALID_PHONE_NUMBER_ERROR,
  DELIVERY_ADDRESS_SAVE_TOO_LONG_ERROR,
  DELIVERY_ADDRESS_SAVE_FLATANDFLOOR_TOO_LONG_ERROR,
