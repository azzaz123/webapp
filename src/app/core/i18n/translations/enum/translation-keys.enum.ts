export enum TRANSLATION_KEY {
  ...
  BANK_DETAILS_POPUP_REMOVE_BANK_ACCOUNT_TITLE,
  BANK_DETAILS_POPUP_REMOVE_BANK_ACCOUNT_DESCRIPTION,
  BANK_DETAILS_POPUP_REMOVE_BANK_ACCOUNT_CONFIRM,
  BANK_DETAILS_POPUP_REMOVE_BANK_ACCOUNT_CANCEL,
  BANK_DETAILS_POPUP_REMOVE_CREDIT_CARD_TITLE,
  BANK_DETAILS_POPUP_REMOVE_CREDIT_CARD_DESCRIPTION,
  BANK_DETAILS_POPUP_REMOVE_CREDIT_CARD_CONFIRM,
  BANK_DETAILS_POPUP_REMOVE_CREDIT_CARD_CANCEL,
  BANK_DETAILS_DELETE_BANK_ACCOUNT_SUCCESS,
  BANK_DETAILS_DELETE_BANK_ACCOUNT_ERROR,
  BANK_DETAILS_DELETE_CREDIT_CARD_SUCCESS,
  BANK_DETAILS_DELETE_CREDIT_CARD_ERROR,
