...
import {
  NEW_CONVERSATION_RESPONSE, ItemService, UserService, PersistencyService, EventService, NotificationService,
  XmppService, MessageService, TrackingService, NewConversationResponse, HttpService, TEST_HTTP_PROVIDERS,
  MOCK_USER, MOCK_ITEM, Conversation
} from 'shield';
