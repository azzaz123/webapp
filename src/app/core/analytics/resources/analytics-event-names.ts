export enum ANALYTICS_EVENT_NAMES {
  ...
  AcceptMGMHostInvitation = 'Accept MGM Host Invitation',
  AchieveMGMHostReward = 'Achieve MGM Host Reward',
  ApproveLogin = 'Approve Login',
  ClickUnlinkSocialAccountOption = 'Click Unlink Social Account Option',
  ExpireMGMGuestReward = 'Expire MGM Guest Reward',
  ExpireMGMHostListingTime = 'Expire MGM Host Listing Time',
  ExpireMGMHostReward = 'Expire MGM Host Reward',
  ...
  MGMRewardUnused = 'MGM Reward Unused',
  ...
  CancelMGMRewardUsed = 'Cancel MGM Reward Used',
  ...
  UpdateCLMNotification = 'Update CLM Notification',
  UpdateCommercialCommunicationsConsent = 'Update Commercial Communications Consent',
  UpdatePromoNotification = 'Update Promo Notification',
