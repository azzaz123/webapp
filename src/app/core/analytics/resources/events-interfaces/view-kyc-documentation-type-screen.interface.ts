...
/**
 * User views KYC documentation type screen
 */
export interface ViewKYCDocumentationTypeScreen {
  /**
   * Identifier of the user viewing KYC documentation type screen
   */
  userId?: string;
  /**
  ...
  /**
   * Identifier of the KYC documentation type screen
   */
  screenId: 200;
}
