...
/**
 * User views an impression of the wall recommendation slider
 */
export interface ImpressionWallRecommendationSlider {
  /**
  ...
  screenId: 110;
  /**
   * Name of the experiment or A/B testing applied to the user who has viewed the wall recommendation slider. The default value would be 'baseline'
   */
  experiment?: string;
}
