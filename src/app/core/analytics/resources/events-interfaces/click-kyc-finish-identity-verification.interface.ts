...
/**
 * User clicks finish verification button on KYC review documentation image screen
 */
export interface ClickKYCFinishIdentityVerification {
  /**
   * Identifier of the user clicking finish verification button on KYC review documentation image screen
   */
  userId?: string;
  /**
