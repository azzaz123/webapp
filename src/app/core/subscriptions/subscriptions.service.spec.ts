...
describe('SubscriptionsService', () => {
  ...
  describe('newSubscription', () => {
    it('should call endpoint', () => {
      ...
      const expectedUrl = `${environment.baseUrl}${API_URL}/c2b/stripe/subscription/1-2-3`;
      const expectedBody = {
  ...
  describe('checkRetrySubscriptionStatus', () => {
    it('should call endpoint', () => {
      const expectedUrl = `${environment.baseUrl}${API_URL}/c2b/stripe/subscription/payment_attempt/1-2-3`;
