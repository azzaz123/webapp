...
export function generateBaseHelpPagesByLocale(locale: HELP_LOCALE): CustomerHelpPages {
  return {
    ...
    [CUSTOMER_HELP_PAGE.ACCEPT_SCREEN]: getCustomerHelpUrl(EXTERNAL_CUSTOMER_HELP_PAGE_ID.ACCEPT_SCREEN, locale),
    [CUSTOMER_HELP_PAGE.PAYVIEW]: getCustomerHelpUrl(EXTERNAL_CUSTOMER_HELP_PAGE_ID.PAYVIEW, locale),
    [CUSTOMER_HELP_PAGE.PAYVIEW_DELIVERY]: getCustomerHelpUrl(EXTERNAL_CUSTOMER_HELP_PAGE_ID.PAYVIEW_DELIVERY, locale),
    [CUSTOMER_HELP_PAGE.CANNOT_CHANGE_PRO_SUBSCRIPTION]: getCustomerHelpUrl(
    ...
    [CUSTOMER_HELP_PAGE.TRANSACTIONS_PROTECTION]: getCustomerHelpUrl(EXTERNAL_CUSTOMER_HELP_PAGE_ID.TRANSACTIONS_PROTECTED, locale),
  };
}
