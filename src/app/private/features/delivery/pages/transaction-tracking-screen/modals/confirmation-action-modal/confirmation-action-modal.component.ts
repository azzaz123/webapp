...
import { ConfirmationActionModalProperties } from './confirmation-action-modal.interface';

@Component({
  selector: 'tsl-confirmation-action-modal',
  templateUrl: './confirmation-action-modal.component.html',
})
export class ConfirmationActionModalComponent {
  public properties: ConfirmationActionModalProperties;
