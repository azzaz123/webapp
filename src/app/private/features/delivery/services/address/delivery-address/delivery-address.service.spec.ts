...
describe('DeliveryAddressService', () => {
  ...
  const mockDeliveryAddressErrors: DeliveryAddressError[] = [new PhoneNumberIsInvalidError(), new MobilePhoneNumberIsInvalidError()];
  ...
  describe('when creating the delivery address...', () => {
    ...
    describe('and the petition fails...', () => {
      it('should map the error to DeliveryAddressError', () => {
        ...
        spyOn(deliveryAddressApiService, 'create').and.returnValue(throwError(mockDeliveryAddressErrors));
  ...
  describe('when updating the delivery address...', () => {
    ...
    describe('and the petition fails...', () => {
      it('should map the error to DeliveryAddressError', () => {
        let response: DeliveryAddressError[];
        spyOn(deliveryAddressApiService, 'update').and.returnValue(throwError(mockDeliveryAddressErrors));
