...
import { MyShippingsModule } from './pages/my-shippings/my-shippings.module';
...
const routes: Route[] = [
  {
    ...
    children: [
      ...
      {
        path: DELIVERY_PATHS.MY_SHIPPINGS,
        loadChildren: () => MyShippingsModule,
      },
      {
      ...
      {
        path: '**',
        redirectTo: DELIVERY_PATHS.MY_SHIPPINGS,
      },
    ],
  },
];
