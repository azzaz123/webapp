...
export const completedTransactionTrackingStatusAsBuyerTranslations = (
  ...
  const translations: Record<COMPLETED_TRANSACTION_TRACKING_STATUS, string> = {
    ...
    [COMPLETED_TRANSACTION_TRACKING_STATUS.DISPUTE_CLOSED]: $localize`:@@web_purchases_view_buyer_all_all_dispute_closed_finished_tab_shipping_status_label:Dispute closed on ${interpolation}:INTERPOLATION:`,
    ...
    [COMPLETED_TRANSACTION_TRACKING_STATUS.TRANSACTION_CANCELLED]: $localize`:@@purchases_view_buyer_all_all_transaction_cancelled_finished_tab_shipping_status_label:Cancelled on ${interpolation}:INTERPOLATION:`,
