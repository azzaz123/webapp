...
export const completedTransactionTrackingStatusAsSellerTranslations = (
  ...
  const translations: Record<COMPLETED_TRANSACTION_TRACKING_STATUS, string> = {
    ...
    [COMPLETED_TRANSACTION_TRACKING_STATUS.DISPUTE_CLOSED]: $localize`:@@sales_view_seller_all_all_dispute_closed_finished_tab_shipping_status_label:Dispute closed on ${interpolation}:INTERPOLATION:`,
