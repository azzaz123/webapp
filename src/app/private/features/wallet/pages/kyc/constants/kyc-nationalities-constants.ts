...
export const KYC_NATIONALITIES: KYCNationality[] = [
  {
    ...
    headerText: $localize`:@@kyc_select_document_view_if_eu_top bar_title:European Union`,
  ...
  },
  {
    ...
    headerText: $localize`:@@kyc_select_document_view_if_rest_of_the_world_top bar_title:Rest of the world`,
