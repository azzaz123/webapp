...
import { MOCK_HISTORY_LIST_FROM_WALLET_MOVEMENTS } from '@shared/historic-list/fixtures/historic-list.fixtures.spec';
...
describe('mapWalletBalanceHistoryDetailsToHistoricList', () => {
  describe('when converting wallet balance history details to historic list (web context)', () => {
    it('should map to historic list', () => {
      ...
      const expectedResult = MOCK_HISTORY_LIST_FROM_WALLET_MOVEMENTS;
      const totalBalance = MOCK_HISTORY_LIST_FROM_WALLET_MOVEMENTS.totalBalance;
