...
describe('KYCUploadImagesComponent', () => {
  ...
  describe('and the form is not in progress...', () => {
    beforeEach(() => {
      component.isEndVerificationLoading = false;
    });
  ...
  describe('and the form is already in progress...', () => {
    ...
    it('should mark the save button as loading', () => {
      expectEndVerificationButtonLoading(true);
    });
  });
  ...
  function expectEndVerificationButtonLoading(expectIsLoading: boolean): void {
    const endVerificationButton = de.query(By.css(endVerificationButtonSelector)).componentInstance;

    expect(endVerificationButton.loading).toBe(expectIsLoading);
  }
